...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="bg-[#f8f7f4] text-[#111827] flex min-h-screen flex-col">
            ...
            <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
              ...
              <div className="max-w-xl">
                ...
                <p className="mb-4 text-base leading-7 text-[#4b5563]">
                  ...
                  garden units, backyard studios and small standalone rental spaces.
                </p>

                <p className="text-sm leading-6 text-[#6b7280]">
                  ModRent provides a listing platform only and does not provide
                  legal, tax, planning or building compliance advice.
